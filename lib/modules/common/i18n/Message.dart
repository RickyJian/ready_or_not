...
class Message extends Translations {
  ...
  static const String accountFormUnitNormal = "ACCOUNT_FORM_UNIT_NORMAL";
  static const String accountFormUnitSpecial = "ACCOUNT_FORM_UNIT_SPECIAL";
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          accountFormUnitNormal: 'Normal',
          accountFormUnitSpecial: 'Special',
        ...
        'zh_TW': {
          ...
          accountFormUnitNormal: '一般',
          accountFormUnitSpecial: '特殊',
